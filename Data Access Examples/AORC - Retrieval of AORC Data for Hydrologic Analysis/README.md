...
- **conda_env**: A folder containing the **CondaEnvironmentSetup.ipynb** notebook with instructions and scripts required for setting up a custom conda environment. 
